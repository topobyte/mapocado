...
public class PanelAdjustLuminanceLab extends JPanel
{
	private static final long serialVersionUID = -3346843782923457372L;

	private final ConverterAdjustLuminanceLab converter;
	private JTextField inputLuminance;

	public PanelAdjustLuminanceLab(ConverterAdjustLuminanceLab converter)
	{
		...
		JLabel label = new JLabel("adjust lab luminance");
